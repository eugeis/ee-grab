...
enum class MimeType private constructor(var contentType: String) {
    ...
    pcf("application/x-font"), //    pcf.Z ("application/x-font"),
    ...
    xlt("application/vnd.ms-excel"), xml("application/xml"), xpi("application/x-xpinstall"), xpm("image/x-xpixmap"),
    xsl("application/xml"), xtel("chemical/x-xtel"), xul("application/vnd.mozilla.xul+xml"), xwd("image/x-xwindowdump"),
    xyz("chemical/x-xyz"), zip("application/zip"), zmt("chemical/x-mopac-input"),
    ...
    xlsm("application/vnd.ms-excel.sheet.macroEnabled.12"), xltm("application/vnd.ms-excel.template.macroEnabled.12"),
    xlam("application/vnd.ms-excel.addin.macroEnabled.12"),
    xlsb("application/vnd.ms-excel.sheet.binary.macroEnabled.12"), ppa("application/vnd.ms-powerpoint"),
    ...
    companion object {
        private val contentTypeToMimeType by lazy {
            values().associateBy { it.contentType }
        }

        fun findByContentType(contentType: String): MimeType? {
            return contentTypeToMimeType.get(contentType)
        }
    }
}
